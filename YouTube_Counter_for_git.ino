...
char *  pass;
int testdelay = 1;
#define API_KEY "insert your youtube API key here"
#define CHANNEL_ID "insert your youtube channel ID here"
...
unsigned long api_mtbs = 300000; // update ever 5 mins
...
void loop() {
  ...
  if (millis() - api_lasttime > api_mtbs || initFlag) {
    ...
    if (api.getChannelStatistics(CHANNEL_ID))
    {
      ...
      thousands = ((subs_countInt / 1000) % 1000);
      hundreds = ((subs_countInt / 100) % 100);
